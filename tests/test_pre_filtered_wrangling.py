"""Integration tests for PreFilteredWranglingHandler."""
...
def test_pre_filtered_wrangling_handler_happy_path(
    bigquery_client,
    mock_monitoring_client,
    flask_app,
):
    """Integration test for PreFilteredWranglingHandler happy path.
        ...
        event = CloudEvent(
            ...
            },
            {
                ...
                "payload": {
                    ...
                    "variables": {
                        "partner": "abertta",
                        "refined_unprocessable_claims_output_table": f"{bigquery_client.project}.{dataset_id}.{unprocessable_table_id}",
                        "refined_processable_claims_output_table": f"{bigquery_client.project}.{dataset_id}.{processable_table_id}",
                    },
                },
            },
        )
