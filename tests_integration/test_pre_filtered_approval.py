"""Integration tests for PreFilteredApprovalHandler."""
...
def test_pre_filtered_approval_handler_happy_path(
    bigquery_client,
    mock_monitoring_client,
    flask_app,
):
    """Integration test for PreFilteredApprovalHandler happy path.
    ...
    try:
        ...
        payload = {
            ...
            "payload": {
                ...
                "variables": {
                    "partner": "porto",
                    "unprocessable_claims_input_table": f"{bigquery_client.project}.{dataset_id}.{unprocessable_table_id}",
                    "processable_claims_input_table": f"{bigquery_client.project}.{dataset_id}.{processable_table_id}",
                },
            },
        }
