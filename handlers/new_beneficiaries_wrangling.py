"""Handler for calculating and emitting new beneficiaries metrics for wrangling pipeline.
...
class NewBeneficiariesWranglingHandler(NewBeneficiariesBaseHandler):
    """
