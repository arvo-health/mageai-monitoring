"""Handler for calculating and emitting providers volume ratio metrics for approval pipeline.
...
class ProvidersVolumeRatioApprovalHandler(ProvidersVolumeRatioBaseHandler):
    """
    Calculates and emits metrics for providers volume ratio from approval pipeline.
