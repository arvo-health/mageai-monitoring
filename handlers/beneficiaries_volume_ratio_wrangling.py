"""Handler for calculating and emitting beneficiaries volume ratio metrics for wrangling pipeline.
...
class BeneficiariesVolumeRatioWranglingHandler(BeneficiariesVolumeRatioBaseHandler):
    """
    Calculates and emits metrics for new beneficiaries from wrangling pipeline.
