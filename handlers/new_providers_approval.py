"""Handler for calculating and emitting new providers metrics for approval pipeline.
...
class NewProvidersApprovalHandler(NewProvidersBaseHandler):
    """
    Calculates and emits metrics for new providers from approval pipeline.
